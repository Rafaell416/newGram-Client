...
const newgram = require('../')
const fixtures = require('./fixtures')

let options = {
  endpoints: {
    pictures: 'http://newgram.test/picture',
    users: 'http://newgram.test/user',
    auth: 'http://newgram.test/auth'
  }
}

test.beforeEach(t => {
  t.context.client = newgram.createClient(options)
})
